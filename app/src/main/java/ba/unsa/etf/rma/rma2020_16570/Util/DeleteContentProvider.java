...
public class DeleteContentProvider extends ContentProvider {
    ...
    static {
        ...
        uM.addURI("rma.provider.deletes", "elements", ALL_ROWS);
        uM.addURI("rma.provider.deletes", "elements/#", ONE_ROW);
    }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        switch (uM.match(uri)){
            case ONE_ROW:
                ...
                squery.appendWhere(TransactionDBOpenHelper.DELETE_ID+"="+idRow);
            default:break;
        }
        squery.setTables(TransactionDBOpenHelper.DELETE_TABLE);
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        ...
        long id = database.insert(TransactionDBOpenHelper.DELETE_TABLE, null, values);
    ...
    public int delete(@NonNull Uri uri, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch (uM.match(uri)){
            case ALL_ROWS:
                count = database.delete(TransactionDBOpenHelper.DELETE_TABLE,selection, selectionArgs);
                break;
            case ONE_ROW:
                String segment = uri.getPathSegments().get(1);
                count = database.delete(TransactionDBOpenHelper.DELETE_TABLE, "id = "+segment.trim(), null);
            default:break;
        }
